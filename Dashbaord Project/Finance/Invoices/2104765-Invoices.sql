...
sum(case when datei.printed_at is not null then i.remaining_amount else 0 end) over() as total_outstanding_balance,
...
concat(stg_users.debtor_number,i.printed_at) as drop_id, 
