...
when fs.name in ('Express Jeddah','Express Dammam', 'Express Riyadh') and  li_suppliers.supplier_name in ('Express Jeddah','Express Dammam', 'Express Riyadh', 'Express Tabuk') then 'Astra'
