...
when li_suppliers.supplier_name in ('Floranow Holland') and fs.name in ('Holland Reselling','Holland Reselling Dammam','Holland Reselling Riyadh') then 'Re-Selling'
when li_suppliers.supplier_name in ('Floranow Flash sale') and fs.name in ('Floranow Express Flash sale', 'Floranow Flash Sale Dammam','Floranow Flash Sale Riyadh','Floranow Flash Sale Tabuk', 'Floranow Flash Sale Jeddah') then 'Re-Selling'
...
We are Floranow Multi-Vendor, B2B Digital Marketplaces for flowers

- **Product:** sell sensitive, perishable, short-life shelf products (flowers) that need optimized cool chain solutions.
- We handle all the digital marketplace experience, supply, logistics, and fulfillment processes. (from the farm to the door of the client)
- **Key Process:** Orders, Procurement, Order Confirmation, Order Eencoding, Shipment Consolidation, Flight booking, Shipment Tracking, Clearance, Fulfillment, Receiving, Warehouse Transfers, Stock IN, Stock out, Picking, Cycle Count, Damages, Dispatch, LMD, Delivery, Collection, Customer Returns
- **Key Systems:** Marketplace, Vendor Portal and ERP
- **Key Department:** Digital Marketplace, Growth (Sales), Supply, Logistics, Operations, Finance, HR
- **Key Projects:** Data warhorse Modeling and Tableau Business Intelligence Dashboards,  Business Process Mapping and SOPs.
- **Suppliers Key Challenges:** I’m making the effort to put my availability and pricing. What value can we expect from you?
- **Supplies Key benefits:** **Shopify your business:** you can sell your products on our platforms (online store, storefront that's managed by Floranow)
- **Clients Key Benefits:** Digital Simplified Purchasing, direct transactions with farms lead to lower prices, you can purchase multiple products from multiple farms with a wide assortment availability. (best price, quality and wide assortment for flower, digital shopping experience.
- **Clients Key challenges:**
    1. **Product Selection:** With such a wide variety of flowers and products to choose from, it can sometimes be challenging for clients to make the right selection that fits their needs.
    2. **Delivery Timing:** Due to the perishable nature of flowers, precise timing of deliveries is crucial. Any delays or disruptions can lead to significant loss of quality.
    3. **Price Fluctuations:** Prices for certain types of flowers might fluctuate due to various factors such as seasonality, weather conditions affecting crop yield, etc. This can make budgeting difficult for some clients.
    4. **Quality Variance:** Quality of flowers might vary from batch to batch, or from farm to farm. Ensuring consistency of quality can be a challenge.