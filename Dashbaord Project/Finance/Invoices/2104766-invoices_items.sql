...
when fs.name in ('Express Jeddah','Express Dammam', 'Express Riyadh') and  parent_li_suppliers.supplier_name in ('Holex','Express Dammam', 'Express Riyadh', 'Express Tabuk') then 'Astra'
