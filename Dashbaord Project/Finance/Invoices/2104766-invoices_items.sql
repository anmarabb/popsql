...
when fs.name in ('Express Jeddah','Express Dammam', 'Express Riyadh') and  parent_li_suppliers.supplier_name in ('Holex','Floradelight', 'Waridi', 'Sierra','Vianen','Sierra','Sierra') then 'Astra'
