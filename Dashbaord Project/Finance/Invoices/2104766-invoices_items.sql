...
when ii.meta_data.supplier in ('Astra Farm','Astra farm Barcode','Astra Farm - Event','Astra Flash Sale - R','Astra Flash sale - W') then 'Astra'
...
when ii.product_name like '%Roselily%'  THEN 'Lily Or Double' 
when ii.product_name like '%Rose Tinted%'  THEN 'Rose' 
