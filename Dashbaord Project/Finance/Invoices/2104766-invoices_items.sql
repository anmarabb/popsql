...
case when stg_users.customer_type = 'reseller' and stg_users.warehouse_id in (10,43,76,79) then 'remote branch reseller' else 'main branch reseller' end as reseller
