...
stg_move_items.aging_date,
    ...
    scase when date_diff( cast(current_date() as date ),cast(i.printed_at as date), DAY) > 90 and date_diff( cast(current_date() as date ),cast(i.printed_at as date), DAY) <= 120 then i.remaining_amount else 0 end as between_91_to_120_days,
