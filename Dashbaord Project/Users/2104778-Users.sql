...
case 
    ...
    when stg_invoice_items_customer_id.manual_account_status in ('active') or  max(stg_invoice_items_customer_id.standing_order_account_status) in ('active') then 'active'
    when stg_invoice_items_customer_id.manual_account_status in ('active') or  max(stg_invoice_items_customer_id.standing_order_account_status) in ('active') then 'active'
