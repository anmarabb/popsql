...
when st.id in (522,484,567,566,531,530,523,485,373,372,301,300,199,198,131,130,127,126,57,56,21,20,7,6,2,1) then  case  when stg_suppliers.supplier_name = 'Commission Based' then 'Commission Based - Astra Express' else 'Reselling' end 
else null
end as stock_model,
