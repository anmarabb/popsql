...
sum (case when date_diff(current_date(),date(i.printed_at), WEEK) = 0 and li_suppliers.supplier_region = 'Holland' then ii.price_without_tax else 0 end) as last_week_holland,
sum (case when date_diff(current_date(),date(i.printed_at), WEEK) = 1 and li_suppliers.supplier_region = 'Holland' then ii.price_without_tax else 0 end) as last_week_holland,
sum (case when date_diff(current_date(),date(i.printed_at), WEEK) = 2 and li_suppliers.supplier_region = 'Holland' then ii.price_without_tax else 0 end) as last_week_holland,
