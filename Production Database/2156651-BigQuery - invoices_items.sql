...
where ii.deleted_at is null and  ii.__hevo__marked_deleted is not true and EXTRACT(YEAR FROM i.printed_at) = EXTRACT(YEAR FROM DATE_SUB(CURRENT_DATE(), INTERVAL 1 MONTH)) and